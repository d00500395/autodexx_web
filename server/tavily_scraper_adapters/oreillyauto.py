"""LLM-guided O'Reilly adapter."""

from __future__ import annotations

from .legacy.oreillyauto import OReillyAdapter as LegacyOReillyAdapter
from .llm_guided import LLMGuidedAdapterMixin


class OReillyLLMAdapter(LLMGuidedAdapterMixin, LegacyOReillyAdapter):
    """O'Reilly adapter with LLM-guided in-page navigation fallback."""
